/****************************************************************************
** Meta object code from reading C++ file 'Monster.hpp'
**
...
#error "The header file 'Monster.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Monster_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Monster_t qt_meta_stringdata_Monster = {
    {
        QT_MOC_LITERAL(0, 7),  // "Monster"
        QT_MOC_LITERAL(8, 4),  // "move"
        QT_MOC_LITERAL(13, 0),  // ""
        QT_MOC_LITERAL(14, 6)   // "attack"
    },
    "Monster",
    "move",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_Monster[] = {
...
Q_CONSTINIT const QMetaObject Monster::staticMetaObject = { {
    ...
    qt_meta_stringdata_Monster.offsetsAndSizes,
