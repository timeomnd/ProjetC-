/****************************************************************************
** Meta object code from reading C++ file 'Weapons.hpp'
**
...
#error "The header file 'Weapons.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Weapon_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Weapon_t qt_meta_stringdata_Weapon = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Weapon[] = {
...
Q_CONSTINIT const QMetaObject Weapon::staticMetaObject = { {
    ...
    qt_meta_stringdata_Weapon.offsetsAndSizes,
    qt_meta_data_Weapon,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Weapon_t,
        // Q_OBJECT / Q_GADGET
